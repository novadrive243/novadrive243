    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-28 pb-16 px-4">
        <div className="container mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-nova-white border-2 border-nova-gold inline-block px-6 py-3 rounded-lg">
          ...
          <div className="mt-12 p-6 nova-card max-w-2xl mx-auto">
            <h3 className="text-xl font-bold mb-4 text-nova-gold text-center border-2 border-nova-gold inline-block px-4 py-2 rounded-lg">Informations supplémentaires</h3>
