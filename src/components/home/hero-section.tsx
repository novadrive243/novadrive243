      ...
      <div className="container mx-auto px-4 z-10 text-center py-16">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 animate-fade-in">
            <span className="bg-gold-gradient text-white px-6 py-2 rounded-lg shadow-[0_0_20px_rgba(232,191,82,0.6)] border border-nova-gold/30 font-sfpro">NovaDrive</span>
          </h1>
